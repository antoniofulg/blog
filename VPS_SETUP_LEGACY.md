# Legacy VPS Setup Checklist

> Legacy direct-Docker-Compose setup. Current production deployment uses the self-hosted Coolify flow documented in `.agents/rules/cicd.md`. Do not apply this checklist to the current VPS unless intentionally restoring the legacy stack.
